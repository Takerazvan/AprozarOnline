...
public class CustomerService extends AppUserService {
    ...
    @Autowired
    public CustomerService(@Qualifier("jpa") AppUserDao appUserDao, AppUserDTOMapper userDTOMapper, PasswordEncoder passwordEncoder, S3Service s3Service, S3Buckets s3Buckets, ShoppingCartRepository shoppingCartRepository, ShoppingCartRepository shoppingCartRepository1) {
